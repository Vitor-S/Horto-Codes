<?php include("../conexao.php");
    ...
    if (isset($_FILES['arquivo'])) {
        ...
        try {
            $arquivo_sql = "UPDATE ROBOCODE SET BANNER_ROBO = :img WHERE (ID_ROBO = :id)";
...
?>
    ...
    <h1>Upload banner robos</h1>

    <form action="upBanner.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="arquivo" required>
        <label for="arquivo">Arquivo:</label>
        <select name="id" required>
            <option value=""> --- Banner Robos --- </option>
            <?php
        ...
        <button type="sumbit" value="Salvar" id="upBtn">Salvar</button>
    </form>
